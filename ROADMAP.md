...
1. **Device configuration model** — typed configuration policy for the
   levitated dipole (coil-system classes, levitation envelopes, heating
   inventory), with evidence-maturity target `computational_prototype`.
2. **Diagnostic and clock semantics** — declared dipole flux-coordinate
