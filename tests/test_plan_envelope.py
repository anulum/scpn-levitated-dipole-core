...
# SCPN Levitated Dipole Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "d2f2ae274efee2765d67b4d5454a4e07cfb6cd7830e161050413898ec10e5f10"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-LEVITATED-DIPOLE-CORE"
    assert NON_CLAIMS == (
