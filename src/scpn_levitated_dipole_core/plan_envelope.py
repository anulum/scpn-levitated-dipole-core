...
# SCPN Levitated Dipole Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-LEVITATED-DIPOLE-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_levitated_dipole_core.observability.CATALOGUE_BINDING`.
    plan_identifier
